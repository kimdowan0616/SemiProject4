...
<script type="text/javascript">
        $(document).ready(function () {
            $("ul[id*=category_down] li").click(function () {
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" id="category_down"
					...
					<li><a class="dropdown-item" value="furniture" href="test.jsp">가구</a></li>
					<li><a class="dropdown-item" value="fabric" href="https://www.naver.com">패브릭</a></li>
					<li><a class="dropdown-item" value="homeElec" href="#">가전</a></li>
					<li><a class="dropdown-item" value="life" href="#">생활용품</a></li>
					<li><a class="dropdown-item" value="pet" href="#">반려동물</a></li>
				</ul>
				...
				<ul class="navbar-nav ms-left">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded">
							<form class="d-flex" name="frmSearch" method="post" action='store3_keyword.jsp'>
