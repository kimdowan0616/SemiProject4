...
<%
	...
	if(request.getParameter("searchKeyword")!=null && !request.getParameter("searchKeyword").isEmpty()){
		keyword = request.getParameter("searchKeyword");
	}else if(request.getParameter("searchCategory")!=null && !request.getParameter("searchCategory").isEmpty()){
